...
`msg.payload.parameters` property, an object that lists all parameters provided in the url.
`msg.payload.clientTimezone` property, a string providing the clients Timezone.
